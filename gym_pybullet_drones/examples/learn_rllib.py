...
def env_creator_quad3d(env_config):
    from gym_pybullet_drones.envs.single_agent_rl import HoverAviary
    env = gymnasium.make('hover-aviary-v0')
...
def train_rfsac(config):
    ...
    register_env('hover-aviary-v0', env_creator_quad3d)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", default='hover-aviary-v0', type=str)
    ...
    config.update({'algo': tune.grid_search(['SAC'])})
